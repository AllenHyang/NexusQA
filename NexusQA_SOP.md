...
## 2. Phase 1: 输入准备 (Preparation)

任何测试活动的起点，质量的源头。

### 2.1 用户故事 (User Story) 准入标准
...
## 3. Phase 2: 测试生命周期 (Lifecycle)

测试执行的核心闭环，必须严丝合缝。

### 3.1 用例设计 (Test Case Design)
...
## 4. Phase 3: 回溯与优化 (Improvement)

没有回溯的测试只是重复劳动。

### 4.1 质量复盘 (Quality Review)
