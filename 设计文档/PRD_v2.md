...
- [ ] AC1: 追溯视图显示每个需求的测试覆盖率
- [ ] AC2: 未覆盖的需求/AC 高亮显示
- [ ] AC3: 点击用例可跳转到用例详情页
- [ ] AC4: 支持按覆盖状态筛选（全覆盖/部分覆盖/未覆盖）
- [ ] AC5: 支持导出追溯矩阵（Excel 格式）
...
| 功能编号 | 功能名称 | 优先级 | 状态 | 关联场景 |
|---------|---------|-------|------|---------|
| F-RQ-001 | 创建需求 | P1 | 待开发 | US-008 |
| F-RQ-002 | 需求列表 | P1 | 待开发 | US-008, US-010 |
| F-RQ-003 | 编辑需求 | P1 | 待开发 | US-008 |
| F-RQ-004 | 需求详情 | P1 | 待开发 | US-009, US-010 |
| F-RQ-005 | 需求状态流转 | P1 | 待开发 | US-008 |
| F-RQ-006 | 关联测试用例 | P1 | 待开发 | US-010 |
| F-RQ-007 | 功能验收 | P2 | 待开发 | US-009 |
| F-RQ-008 | 需求追溯视图 | P2 | 待开发 | US-010 |
| F-RQ-009 | 追溯矩阵导出 | P2 | 待开发 | US-010 |
...
验收标准：
- [ ] 产品经理可查看需求关联的所有测试用例执行状态
- [ ] 显示测试覆盖率：已覆盖 AC 数 / 总 AC 数
- [ ] 显示测试通过率：PASSED / (PASSED + FAILED)
- [ ] 验收不通过时必须填写验收意见
- [ ] 验收历史可追溯（acceptedBy, acceptedAt, acceptanceNotes）
...
│  │  ─────────────────────────────────────────────────────────────────────── │  │
│  │                                                                           │  │
│  │  ☐  REQ-001 用户登录功能               ● 已批准    🔴 P0    3/3   ✅     │  │
│  │     验收标准: 3 条  |  关联用例: 5 个  |  创建者: 张三  |  2天前          │  │
│  │                                                                           │  │
│  │  ☐  REQ-002 密码重置功能               ● 进行中    🟠 P1    2/3   ⏳     │  │
│  │     验收标准: 3 条  |  关联用例: 4 个  |  创建者: 张三  |  3天前          │  │
│  │                                                                           │  │
│  │  ☐  REQ-003 用户注册功能               ● 待评审    🟠 P1    0/4   ⏳     │  │
│  │     验收标准: 4 条  |  关联用例: 0 个  |  创建者: 李四  |  5天前          │  │
│  │     ⚠️ 未关联测试用例                                                     │  │
│  │                                                                           │  │
│  │  ☐  REQ-004 个人中心设置               ○ 草稿      🔵 P2    0/2   ⏳     │  │
│  │     验收标准: 2 条  |  关联用例: 0 个  |  创建者: 王五  |  1周前          │  │
│  │                                                                           │  │
│  └───────────────────────────────────────────────────────────────────────────┘  │
│                                                                                  │
│  显示 1-4 共 24 条                                      < 1 2 3 4 5 ... 6 >     │
│                                                                                  │
└─────────────────────────────────────────────────────────────────────────────────┘
